            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
              ...
              <div className="space-y-4">
                ...
                <div className="flex space-x-3">
                  <Link href="https://www.linkedin.com/company/94238033" className="text-gray-400 hover:text-[#135142] dark:hover:text-green-400 transition-colors" aria-label="LinkedIn">
                  ...
                  <Link href="https://www.youtube.com/@ChatFinai" className="text-gray-400 hover:text-[#135142] dark:hover:text-green-400 transition-colors" aria-label="YouTube">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M19.615 6.784A2.503 2.503 0 0017.86 5.03C16.302 4.625 10 4.625 10 4.625s-6.302 0-7.86.405A2.503 2.503 0 00.385 6.784 26.226 26.226 0 000 10c0 1.163.129 2.315.385 3.216a2.503 2.503 0 001.755 1.754c1.558.405 7.86.405 7.86.405s6.302 0 7.86-.405a2.503 2.503 0 001.755-1.754c.256-.901.385-2.053.385-3.216a26.226 26.226 0 00-.385-3.216zM8 12.5V7.5l5.25 2.5L8 12.5z" />
                    </svg>
                  </Link>
                  <Link href="https://github.com/ChatFin-Labs" className="text-gray-400 hover:text-[#135142] dark:hover:text-green-400 transition-colors" aria-label="GitHub">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  ...
                  <Link href="https://www.figma.com/@chatfin" className="text-gray-400 hover:text-[#135142] dark:hover:text-green-400 transition-colors" aria-label="Figma">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M10 0C8.343 0 7 1.343 7 3v4c0 .342.058.668.162.975A2.99 2.99 0 006 8c-1.657 0-3 1.343-3 3s1.343 3 3 3c.768 0 1.47-.29 2-.764v.764c0 1.657 1.343 3 3 3s3-1.343 3-3v-4c0-.342-.058-.668-.162-.975A2.99 2.99 0 0014 9c1.657 0 3-1.343 3-3s-1.343-3-3-3c-.768 0-1.47.29-2 .764V3c0-1.657-1.343-3-3-3z" />
                    </svg>
                  </Link>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Link href="/careers" className="block text-gray-600 dark:text-gray-300 hover:text-[#135142] dark:hover:text-green-400 text-sm transition-colors">Careers</Link>
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 mt-8 pt-8">
              <div className="text-center mb-4">
                <p className="text-gray-600 dark:text-gray-300 text-sm mb-2">
                  Visit us: <Link href="https://chatfin.ai/" className="text-[#135142] dark:text-green-400 hover:underline">chatfin.ai</Link> | <Link href="https://chatfin.ai/talk-to-us" className="text-[#135142] dark:text-green-400 hover:underline">Contact Us</Link>
                </p>
              </div>
