                    ...
                    <div className="grid lg:grid-cols-2 gap-16 max-w-6xl mx-auto">
                        ...
                        <div className="space-y-8">
                            <div className="text-center lg:text-left">
                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 dark:bg-green-900/30 rounded-full mb-4">
                                    ...
                                    <span className="text-sm font-semibold text-green-700 dark:text-green-300">Personal Finance</span>
                                </div>
                                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-4">
                                    Take control of your money
                                </h3>
                                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                                    Smart budgeting, expense tracking, and financial insights to help you reach your goals.
                                </p>
                            </div>
                        ...
                        <div className="space-y-8">
                            <div className="text-center lg:text-left">
                                ...
                                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                                    Advanced features, team collaboration, and enterprise integrations for growing businesses.
                                </p>
                            </div>
                            ...
                            <Button
                                ...
                                variant="outline"
                                className="border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-xl"
                            >
                                Schedule Demo
                                <ArrowRight className="ml-2 w-4 h-4" />
                            </Button>
